...
const service_data: DataType[] = [
   {
      id: 1,
      icon: (<><svg width="18" height="22" viewBox="0 0 18 22" fill="none"
      ...
      desc: "Unlock your highest potential and cultivate habits aligned with your true self",
   },
   {
      id: 2,
      icon: (<><svg width="16" height="23" viewBox="0 0 16 23" fill="none"
         xmlns="http://www.w3.org/2000/svg">
         <path
      ...
      desc: "Find clarity, direction, and confidence to thrive in your career journey.",
   },
   {
      id: 3,
      ...
      desc: "Break free from limiting beliefs and adopt a powerful, growth-focused mindset",
   },
   {
      id: 4,
      icon: (<><svg width="24" height="25" viewBox="0 0 24 25" fill="none"
      ...
      title: "Relationship",
      desc: "Strengthen your relationships by nurturing connection, communication, and self-love",
   },
]
            ...
            <div className="row g-lg-4 g-3 align-items-end justify-content-between mb-40">
               <div className="col-lg-7 col-md-7">
                  <div className="section-header">
                     <span
                        className="text-uppercase theme-clr4 theme4-border rounded-5 fw-600 d-inline-block py-0 mb-3 px-3">Services</span>
               ...
               <div className="col-lg-4 col-md-5">
                  <div className="wow fadeInUp" data-wow-delay=".4s">
                     ...
                     <Link to="/services" className="theme-btn style3 pe-20 wow fadeIn" data-wow-delay=".4s">
                        <i
            ...
            <div className="row g-4">
               {service_data.map((item) => (
                  <div key={item.id} className="col-sm-6 col-lg-4 col-xl-3">
                     <div className="service-items2 section-bg rounded-4 z-1 position-relative">
                        ...
                        <div className="content">
                           ...
                           <p className="black-clr mb-3">{item.desc}</p>
                           <Link to="/services-details" className="link-btn d-flex align-items-center gap-3 fw-600 theme-clr4">
