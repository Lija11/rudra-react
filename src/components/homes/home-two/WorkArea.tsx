               ...
               <div className="row g-4 justify-content-between">
                  <div className="col-lg-6">
                     <div className="section-header mb-40">
                        <span
                           className="text-uppercase theme-clr4 theme4-border rounded-5 fw-600 d-inline-block py-0 mb-3 px-3">Why
                           wrok with me</span>
                        <h2 className="theme-clr4 fw-800 mb-lg-4 mb-sm-3 mb-2 fw-bold wow fadeInUp" data-wow-delay=".3s">
                           A Holistic Approach
                           <span className="fw-300" style={{ display: "inline-block" }}>Focused Entirely on You</span>
                        </h2>
                        <p>
                     ...
                     <div className="nano-project-image position-relative w-100">
                        <img src="/assets/img/about/about-thumb2.png" alt="img" className="rounded-3 w-100" />
                  ...
                  <div className="col-lg-6">
                     <div className="work-wrapper d-flex flex-column">
                        {work_data.map((item) => (
                           <div key={item.id} className={`work-list-item rounded-3 bg-white d-flex gap-xl-4 gap-3 ${item.class} wow fadeInUp`}
                              data-wow-delay=".2s">
                              ...
                              <div>
                                 ...
                                 <p className="black-clr">{item.title}</p>
                              </div>
                           </div>
                        ))}
                     </div>
